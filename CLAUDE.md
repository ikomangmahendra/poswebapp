...
- Frontend build: Vite + Tailwind CSS v4 (`resources/css/app.css` shared by every page; no shared JS entry — each page loads only its own module's JS file, see "Frontend" below), no JS framework (React/Vue) installed
